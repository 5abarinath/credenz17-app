...
public class activity_wallstreet extends AppCompatActivity {
...
//    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public PlaceholderFragment() { //TODO: Add correct data
            DATA[0] = R.string.wall_intro;
            DATA[1] = R.string.wall_rules;
            DATA[2] = R.string.wall_structure;
            DATA[3] = R.string.wall_judging;
        }
    ...
    public static class EventFragment_contact extends Fragment {
        ...
        public EventFragment_contact() { //TODO: Add correct data
            CONTACT_DATA[0] = R.string.wall_coord1;
            CONTACT_DATA[1] = R.string.wall_coord1_contact;
            CONTACT_DATA[2] = R.string.wall_coord2;
            CONTACT_DATA[3] = R.string.wall_coord2_contact;
            CONTACT_DATA[4] = R.string.wall_email;
        }
