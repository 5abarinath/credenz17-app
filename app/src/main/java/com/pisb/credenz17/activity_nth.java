...
public class activity_nth extends AppCompatActivity {
...
//    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public PlaceholderFragment() {
            DATA[0] = R.string.nth_intro;
            DATA[1] = R.string.nth_rules;
            DATA[2] = R.string.nth_structure;
            DATA[3] = R.string.nth_judging;
        }
    ...
    public static class EventFragment_contact extends Fragment {
        ...
        public EventFragment_contact() {
            CONTACT_DATA[0] = R.string.nth_coord1;
            CONTACT_DATA[1] = R.string.nth_coord1_contact;
            CONTACT_DATA[2] = R.string.nth_coord2;
            CONTACT_DATA[3] = R.string.nth_coord2_contact;
            CONTACT_DATA[4] = R.string.nth_email;
        }
