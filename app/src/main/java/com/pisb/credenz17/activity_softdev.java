...
public class activity_softdev extends AppCompatActivity {
...
//    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public PlaceholderFragment() {  //TODO: Add correct data
            DATA[0] = R.string.softdev_intro;
            DATA[1] = R.string.softdev_rules;
            DATA[2] = R.string.softdev_question;
            DATA[3] = R.string.softdev_structure;
            DATA[4] = R.string.softdev_judging;
        }
    ...
    public static class EventFragment_contact extends Fragment {
        ...
        public EventFragment_contact() { //TODO: Add Correct Data
            CONTACT_DATA[0] = R.string.softdev_coord1;
            CONTACT_DATA[1] = R.string.softdev_coord1_contact;
            CONTACT_DATA[2] = R.string.softdev_coord2;
            CONTACT_DATA[3] = R.string.softdev_coord2_contact;
            CONTACT_DATA[4] = R.string.softdev_email;
        }
