...
public class activity_rc extends AppCompatActivity {
...
//    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public PlaceholderFragment() {
            DATA[0] = R.string.rc_intro;
            DATA[1] = R.string.rc_rules;
            DATA[2] = R.string.rc_structure;
            DATA[3] = R.string.rc_judging;
        }
    ...
    public static class EventFragment_contact extends Fragment {
        ...
        public EventFragment_contact() {
            CONTACT_DATA[0] = R.string.rc_coord1;
            CONTACT_DATA[1] = R.string.rc_coord1_contact;
            CONTACT_DATA[2] = R.string.rc_coord2;
            CONTACT_DATA[3] = R.string.rc_coord2_contact;
            CONTACT_DATA[4] = R.string.rc_email;
        }
