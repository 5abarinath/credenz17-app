...
public class activity_xodia extends AppCompatActivity {
...
//    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public PlaceholderFragment() {  //TODO: Add correct data
            DATA[0] = R.string.xodia_intro;
            DATA[1] = R.string.xodia_rules;
            DATA[2] = R.string.xodia_structure;
            DATA[3] = R.string.xodia_judging;
        }
    ...
    public static class EventFragment_contact extends Fragment {
        ...
        public EventFragment_contact() { //TODO: Add Correct Data
            CONTACT_DATA[0] = R.string.xodia_coord1;
            CONTACT_DATA[1] = R.string.xodia_coord1_contact;
            CONTACT_DATA[2] = R.string.xodia_coord2;
            CONTACT_DATA[3] = R.string.xodia_coord2_contact;
            CONTACT_DATA[4] = R.string.xodia_email;
        }
